<div style="margin-bottom: 35 vh ;" class="d-flex justify-content-center m-5"enctype="multipart/form-data"  >
<form action="<?= URL ?>inscription/ic"  class=" w-50" method="POST">

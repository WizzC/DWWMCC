...
<body style="background-color: black;">
  ...
  <nav class="navbar navbar-expand-lg " style="background-color: #BA5C12;">
    <div class="container-fluid">
      <a class="navbar-brand" aria-current="page" href="<?= URL ?>accueil">Accueil</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="<?= URL ?>listeAnime">listeAnime</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="<?= URL ?>listeScan">listeScan</a>
          </li>
        </ul>
        <form class="d-flex" role="search" method="POST">
          <input class="form-control me-2" type="search" placeholder="Recherche" aria-label="Search" name="recherche">
          <input class="btn btn-outline-dark" type="submit" name="valider" value="rechercher"></input>
        </form>
      </div>
    </div>
  </nav>

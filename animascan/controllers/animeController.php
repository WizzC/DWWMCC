...
class AnimeController {
    ...
    public function modificationAnimeValidation(){
        $imageActuelle = $this->animeManager->getAnimeById((int)$_POST['identifiantAnime'])->getImageAnime();
        $file = $_FILES['imageAnime'];
        ...
        $this->animeManager->modificationAnimeBD((int)$_POST['identifiantAnime'],$_POST["nom"],$_POST["dateAnime"],$_POST["auteur"],$_POST["descriptionAnime"],$nomImageTooAdd);
        $_SESSION['alert']= [
            "type"=> "success",
